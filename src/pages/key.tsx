...
const FormList: Form[] = [
  ...
  },
  {
    ...
    description:
      'These are trumpet-shaped mushrooms. Although they appear to have gills at first glance, the spore producing surface is not easily separable from the cap and stem, and are actually folding structures rather than true gills. Many are delicious edibles.',
    images: [
  ...
  },
  {
    ...
    description:
      'The discomyetes or "Disc fungi". These mushrooms are generally small and disc to cup shaped, saddle-shaped, folded, or "shucked corn-cob shaped" like the Morel.',
    images: [
  ...
  },
  {
    ...
    description:
      'These mushrooms have pores on the underside of the cap (polypore = "many pores") and generally grow on wood. The pore surface is generally not separable from the cap and many species are quite tough. Polypores take can take additional descriptive forms, including conks, shelves, rosettes, and crusts.',
    images: [
  ...
  },
  {
    ...
    description:
      "Conks usually don't have a stem, are usually stout, growing on wood, commonly hard perennials. They can have pores, teeth, and sometimes hard, mock gills. Pores can be round, oblonged, angular, or maze-like.",
    images: [
  ...
  },
  {
    ...
    images: ['stereum-lobatum-6734-1.jpeg', 'cerrena-unicolor1.jpeg'],
  },
  {
    name: 'Crust Fungi',
    url: '/location/all/?t=crust',
    description:
      'Corticioid. Crust fungi are found growing flat against a surface, generally a downed tree. Pores may be visible. They may also be smooth, wrinkled, soft, hard, wet, or dry. They come in an array of colors can be easily found in most seasons.',
    images: [
  ...
  },
  {
    ...
    description:
      'As the name suggests, this form is reminiscent of underwater coral structures, generally branching into separate segments as it grows from the base.',
    images: ['/artomyces-pyxidatus5.jpeg'],
  },
  {
    name: 'Club Fungi',
    url: '/location/all/?t=club',
    description:
      'These mushrooms are club-shaped, are often colorful, generally small.',
    images: [
  ...
  },
  {
    ...
    description:
      'These mushrooms have spore bearing surfaces that are a sharp tooth-shape, similar to stalactites on the roof of a cave.',
    images: [
  ...
  },
  {
    ...
    images: ['/crucibulum-parvulum-6258-1.jpeg'],
  },
  {
    ...
    <>
      {!!form && (
        <>
          <hr />
          <h4>
            <Link to={form.url}>{form.name}</Link>
          </h4>
    ...
    <PageLayout>
      <div className="container">
        <div className="row">
          ...
          <div>
            <p>
              This website allows you to see lists of mushrooms organized by
              where they are found in Nebraska parks. Links from the below
              identification key will direct you to different lists of mushrooms
              that have been surveyed in Nebraska parks. For more advanced
              queries, please see{' '}
              <Link to="/articles/manual">the website manual</Link>.
            </p>
          </div>
          <div>
            <h3>Key to Major Forms</h3>
            <p>
              A form is a unique shape that any given mushroom can feature.
              Below are common forms. To identify a mushroom, start here. Does
              your mushroom match the form? If so, click the name. If it doesn't
              match, continue on down the list. Keep in mind that fungi forms
              often overlap and commonly fit into multiple categories.
            </p>
            {FormList.map((x) => (
              <FormCard key={x.name} form={x} />
            ))}
          </div>
        </div>
      </div>
