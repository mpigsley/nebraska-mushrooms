...
* Thoroughly cook your mushrooms. It takes time to break them down and make them more digestible. Wild mushrooms are NOT a direct replacement for button mushrooms in cooking. Wild mushrooms need to be cooked longer. Raw morels are known by the CDC to be [poisonous](https://www.cdc.gov/mmwr/volumes/73/wr/mm7310a1.htm).

## When in doubt, throw it out!

Further education:
* [Mushroom Poisoning Syndromes](https://namyco.org/interests/toxicology/mushroom-poisoning-syndromes/)