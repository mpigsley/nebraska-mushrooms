...
external_links:
  - tag: MycoBank
    link: https://www.mycobank.org/page/Name%20details%20page/47739
  - tag: iNaturalist Species Description
    link: https://www.inaturalist.org/taxa/154733
  - tag: Mushroom Observer Species Description
    link: https://mushroomobserver.org/names?pattern=Crepidotus%20crocophyllus
  - tag: Mushroom Expert
    link: https://www.google.com/search?q=Crepidotus%20crocophyllus+site:www.mushroomexpert.com
  - tag: Google Scholar
    link: https://scholar.google.com/scholar?&q=Crepidotus%20crocophyllus
photos:
  - /img/crepidotus-crocophyllus-286602636-1.jpeg
  - /img/crepidotus-crocophyllus-166139090-4.jpeg
  - /img/crepidotus-crocophyllus-166139090-3.jpeg
  - /img/crepidotus-crocophyllus-286602636-3.jpeg
  - /img/crepidotus-crocophyllus-286602636-4.jpeg
---

The Saffron Oysterling (_Crepidotus crocophyllus_) is a wood-decaying fungus (saprotroph) that grows on dead wood. It fruits from spring through fall and is widely distributed across tropical, subtropical, and temperate regions. The fruiting bodies usually grow in clusters or scattered along fallen logs, often resembling small seashells.

The scientific name _crocophyllus_ comes from the Greek _krokos_ (‘saffron, orange-colored’) Latinized to _croc_-, combined with -_phyllon_ (‘leaf’); literally meaning “saffron leaf.” In mycology, the suffix -_phyllus_ refers to gills, highlighting the saffron-yellow gills of young specimens (Donald J. Borror, 1988).
